...
Several years ago, I was challenged to build a multi-purpose production studio on a tight budget.
This was an incredibly fun project, and the result is a highly adaptive AV + lighting + networking setup that supports a main studio, attached live room, and flexible event hall. All engineered to handle a wide (and unpredictable) range of production needs: such as podcasts, live streams, music production/band tracking, corporate events, and beyond.
